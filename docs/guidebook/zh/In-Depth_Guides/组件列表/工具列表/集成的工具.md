...
### 1.2 Bing(必应)搜索
当前集成了Bing官方的搜索
[工具地址](../../../../../../examples/sample_standard_app/intelligence/agentic/tool/bing_search_tool.yaml)  
工具配置：
```yaml
...
### 1.3 Search API
支持多种搜索工具，例如：   
- [百度搜索](../../../../../../examples/sample_standard_app/intelligence/agentic/tool/search_api_baidu_tool.yaml)
- [Bing搜索](../../../../../../examples/sample_standard_app/intelligence/agentic/tool/search_api_bing_tool.yaml)  
