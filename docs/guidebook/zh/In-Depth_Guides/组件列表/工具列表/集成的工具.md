...
### 1.1 谷歌搜索
[工具地址](../../../../../../examples/sample_standard_app/intelligence/agentic/tool/samples/google_search_tool.yaml)  
详细配置信息：
...
### 2.1 PythonRepl
[工具地址](../../../../../../examples/sample_standard_app/intelligence/agentic/tool/samples/python_repl_tool.yaml)  
...
## 3.HTTP 工具
[工具地址](../../../../../../examples/sample_standard_app/intelligence/agentic/tool/samples/request_get_tool.yaml)
